...
{
	textcolor(7);
	cout<<"Write down your suduko as initial stage in a note pad."<<endl;
	cout<<"Give ";
	textcolor(12);
	cout<<" 0 ";
	textcolor(7);
	cout<<" for blank places  ";
	textcolor(15);
	cout<<"AND ";
	textcolor(7);
	cout<<"take a ";
	...
	cout<<"space ";
	textcolor(7);
	cout<<"between every number"<<endl;
	for(int i=8;i>=0;i--)
		for(int j=0;j<9;j++)
		{
		cin>> ini_value[i][j];
...
int main()
{
		...
		textcolor(11);
		cout<<"Calculation complete"<<endl<<"Do you want to see the result";
		textcolor(13);
		cout<<"(y\\n)"<<endl;
		textcolor(15);
		cin>>decission;
		...
		cout<<"If you want to try again prees 'a' or press 'q' for quit"<<endl;
		cin>>running_dec;
		}while(running_dec=='a');
	return 0;
}
